...
var module = angular.module('myApp');
module.controller('ExampleController', function(PagerService, handleRequest) {
    ...
    function initController() {
        ...
        vm.setPage(1);
        var spots = handleRequest.searchForSpots().then(handleSearchResponse, onError);
        // console.log(spots[1]);
    }
    ...
    var handleSearchResponse = function(response) {
        vm.dummyItems = _.range(1, response.length);
        vm.items = response;
        console.log("apedo");
