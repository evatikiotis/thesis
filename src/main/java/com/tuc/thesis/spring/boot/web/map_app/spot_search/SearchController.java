...
public class SearchController {
    ...
    public ResponseEntity<?> searchForSpots(@RequestParam("searchTerm") String searchTerm, @RequestParam("spotType") String spotType) {
        return new ResponseEntity<>(searchService.getSearchResults(spotType, searchTerm), HttpStatus.OK);
    }
